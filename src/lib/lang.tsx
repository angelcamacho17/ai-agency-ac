...
export const UI = {
  es: {
    ...
    partnerH: ['Ahora somos ', 'OpenAI Select Partner.'],
    partnerSub: 'Parte de la OpenAI Partner Network.',
    ...
    processH: ['En vivo en ', 'menos de dos semanas.'],
  ...
  en: {
    ...
    partnerH: ["We're now an ", 'OpenAI Select Partner.'],
    partnerSub: 'Part of the OpenAI Partner Network.',
    capabilitiesH: ['Not a chatbot.', 'A salesperson that ', 'never sleeps.'],
    agentH: ['One agent.', 'Four jobs.'],
    agentAsk: 'Ask about this',
    processH: ['Live in ', 'less than two weeks.'],
